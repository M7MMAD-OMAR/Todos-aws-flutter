...
class Trip extends Model {
  ...
  static final QueryModelIdentifier<TripModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<TripModelIdentifier>();
...
class TripModelIdentifier implements ModelIdentifier<Trip> {
  ...
  const TripModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is TripModelIdentifier && id == other.id;
  }
